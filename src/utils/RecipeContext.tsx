...
export const RecipesContext = createContext<RecipesContextProps>({ recipes: [], setRecipes: () => {}, suggestions: [], setSuggestions: () => {} });
...
export const RecipesProvider: React.FC<RecipesProviderProps> = ({ children, initialRecipes, suggestedRecipes }) => {
  ...
  return (
    <RecipesContext.Provider value={{ recipes, setRecipes, suggestions, setSuggestions }}>
      {children}
